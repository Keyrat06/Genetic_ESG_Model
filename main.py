...
types = ["Bay View", "Big Coal", "Fossil Light","Beachfront", "Tobin", "Big Gas", "East Bay"]
demands = a.demand
colors = ['dimgray','c','g','y','r','b','m']


class GeneticPlayer:
    def __init__(self, capacity, var_cost, OM, num_periods=12, name="", r=0.25, s=0.5):
        self.name = name
...
def mix_players(player_1, player_2):
    new_player = GeneticPlayer(player_1.capacity, player_1.MC, player_1.OM, player_1.num_periods, player_1.name)
